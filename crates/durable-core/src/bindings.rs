        ...
        pub mod notify {
            ...
            pub fn notification_blocking() -> Event {
                unsafe {
                    ...
                    let ptr0 = ret_area.0.as_mut_ptr().cast::<u8>();
                    #[cfg(target_arch = "wasm32")]
                    #[link(wasm_import_module = "durable:core/notify@1.0.0")]
                    extern "C" {
...
\x04\x03\x01\x17durable:core/core@1.0.0\x05\0\x01B\x05\x01r\x02\x07secondsw\x0bn\
...
notification-blocking\x01\x04\x03\x01\x19durable:core/notify@1.0.0\x05\x03\x01B\x02\
