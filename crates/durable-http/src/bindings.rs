        ...
        pub mod http {
            ...
            pub fn fetch(request: HttpRequest<'_>) -> Result<HttpResponse, HttpError> {
                unsafe {
                    ...
                    #[link(wasm_import_module = "durable:core/http@2.2.0")]
                    extern "C" {
                        #[link_name = "fetch"]
                        fn wit_import(
                            _: *mut u8,
...
request\x07\0\x0c\x04\0\x05fetch\x01\x0d\x03\x01\x17durable:core/http@2.2.0\x05\0\
\x04\x01\x1edurable:core/import-http@2.2.0\x04\0\x0b\x11\x01\0\x0bimport-http\x03\
